...
export const HistoryCard = () => {
  return (
    <div className='flex mx-auto w-full h-fit text-wrap'>
      <Card className='overflow-hidden flex-row justify-between py-6 px-4 mx-auto w-full rounded-xl border shadow-sm md:mx-auto md:w-4/5'>
          ...
          <CardContent>
            <div className='flex flex-col gap-2 mr-4 h-full text-left text-pretty'>
              ...
              <ol className='mx-2 list-decimal'>
                ...
                <li>
                  Evita o risco do contagio de doenças infecciosas,
